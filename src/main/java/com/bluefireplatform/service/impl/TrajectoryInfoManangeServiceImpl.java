...
/*     */ 
/*     */ @Service
/*     */ public class TrajectoryInfoManangeServiceImpl
/*     */   implements TrajectoryInfoManangeService
/*     */ {
/*     */   @Autowired
...
/* 204 */     criteria.andOriginalIdEqualTo(originalId);
/* 205 */     List<IndoorMiddleTab> middleList = this.indoorMiddleTabMapper.selectByExample(example);
/* 206 */     JythonUtil jythonUtil; if (middleList.isEmpty()) {
...
/* 220 */         System.out.println("1111111111111111111111111");
